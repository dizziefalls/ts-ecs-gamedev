...
describe('>>> Game', () => {
  ...
  beforeEach(() => {
    ...
    //mock requestAnimationFrame with jest
  ...
  //These tests are about the same as the general ones. We want to see if they still work when for the children of game
